...
/**
 * For localhost SSL testing environment, the client will hit following
 * exceptions, please read the problem and solution below : <br/>
 * 
 * 1) java.security.cert.CertificateException: No name matching localhost found<br/>
 * 
 * 2) SunCertPathBuilderException: unable to find valid certification path to
 * requested target
 * 
 * @author mngo
 * 
...
public class SecureHelloWorldClient {
	/** for Tomcat */
	private static final String WS_URL = "https://localhost:8443/Authentication/hello?wsdl";
	...
	public SecureHelloWorldClient() throws MalformedURLException {
	...
	public static void main(String[] args) throws IOException {
		SecureHelloWorldClient client = new SecureHelloWorldClient();
